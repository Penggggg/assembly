(module
 ...
 (func $~lib/array/Array<i32>#__get (; 14 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  local.get $0
  i32.load offset=12
  i32.ge_u
 ...
 (func $~lib/array/Array<i32>#__set (; 21 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $1
  local.get $0
  i32.load offset=12
 ...
 (func $assembly/index/addArray (; 22 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 2
  local.get $0
  i32.const 0
 ...
 (func $assembly/index/addOneForArr (; 23 ;) (param $0 i32) (result i32)
  (local $1 i32)
  loop $for-loop|0
   local.get $1
   local.get $0
 ...
 (func $~lib/rt/__allocArray (; 24 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 16
  i32.const 3
 ...
 (func $~lib/array/Array<i32>#push (; 25 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  local.get $0
 ...
 (func $assembly/index/arrAdd (; 26 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 352
 ...
 (func $assembly/index/matrixAdd (; 27 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 368
  call $~lib/rt/__allocArray
 ...
 (func $assembly/index/matrixMul (; 28 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 384
  call $~lib/rt/__allocArray
 ...
 (func $assembly/index/polyArrByArr (; 29 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  loop $for-loop|0
   local.get $3
   local.get $2
 ...
 (func $assembly/index/findPolyMatFlattenIndex (; 30 ;) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (result i32)
  (local $7 i32)
  (local $8 i32)
  (local $9 i32)
  i32.const 400
 ...
 (func $assembly/index/test (; 31 ;) (param $0 i32)
  local.get $0
  i32.const 2000000
  i32.const 9
  call $~lib/array/Array<i32>#__set
